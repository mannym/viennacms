		...
		foreach ($aargs as $key => $value) {
			...
			<tr>
				...
				switch ($value['type']) {
					...
					break;
					case 'node':
						echo utils::node_select($key, $value['callback']);
					break;
				}
				?>
				</td>
...
function show_blockform($location) {
	global $node;
	...
	foreach ($node->options['blocks'][$location] as $key => $module) {
		echo '<li><a href="?mode=args&amp;node=' . $node->node_id . '&amp;location=' . $location . '&amp;key=' . $key . '&amp;blocks=true">';
