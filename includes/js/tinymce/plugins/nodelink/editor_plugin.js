var TinyMCE_NodeLinkPlugin = {
	...
	initInstance : function(inst) {
		...
		inst.addShortcut('ctrl', 'n', 'lang_NodeLink_desc', 'mceLinkNode');
	},
		...
		switch (command) {
			...
			case "mceLinkNode":
				...
				//if (user_interface) {
					...
					template['file'] = '../../../../../adm/link_to_node.php'; // Relative to theme
					template['width'] = 600;
					template['height'] = 500;
...
tinyMCE.addPlugin("nodelink", TinyMCE_NodeLinkPlugin);