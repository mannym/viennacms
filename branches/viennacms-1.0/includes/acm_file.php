...
class acm
{
	...
	*/
	function save()
	{
		...
		if ($fp = @fopen($this->cache_dir . 'data_global.php', 'wb'))
		{
			...
			@chmod($this->cache_dir . 'data_global.php', 0666);
		}
		else
		{
			...
			trigger_error('Not able to open ' . $this->cache_dir . 'data_global.php', E_USER_ERROR);
		}
	...
	function put($var_name, $var, $ttl = 31536000)
	{
		if ($var_name[0] == '_')
		{
			...
			if ($fp = @fopen($this->cache_dir . "data{$var_name}.php", 'wb'))
			{
				...
				@chmod($this->cache_dir . "data{$var_name}.php", 0666);
			}
		}
		else
		{
	...
	*/
	function destroy($var_name, $table = '')
	{
		...
		if ($var_name[0] == '_')
		{
			$this->remove_file($this->cache_dir . 'data' . $var_name . ".php");
		}
	...
	*/
	function sql_load($query)
	{
		...
		{
			$this->remove_file($this->cache_dir . 'sql_' . md5($query) . ".php");
			return false;
		}
