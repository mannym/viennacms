...
switch($mode) {
	...
	case 'save':
		...
		if (isset($_POST['submit']) || isset($_GET['ajax'])) {
	...
	case 'args':
		...
		?>
		<form action="?mode=save" id="module_edit_form" method="post">
		...
		?>
			...
			if (isset($_GET['ajax'])) {
				?>
				<a href="#" onclick="reload_module(this.parentNode.parentNode); return false;">^^^^^^^</a>
				<?php
			}
